# 100Hires Assessment - Ardha Ekaputra

Here is the report for the portfolio project:
...
1. Installed Cursor IDE on my local machine.
2. Installed and authenticated the required extensions (Claude Code and Codex).
3. Created a public GitHub repository named `tes-portfolio-ardha`.
4. Cloned the repository to my local environment using Cursor.
5. Created and edited the `README.md` file to document the process.
6. Committed the changes and pushed them back to the GitHub repository.
